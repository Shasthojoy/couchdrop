...
RUN apt-get install -y oracle-java8-installer maven supervisor python-pip python-dev build-essential postgresql-client-common libpq-dev python-dev curl libcurl
